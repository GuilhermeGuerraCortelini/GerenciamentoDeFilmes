...
Route::get('/galeria', [FilmesController::class, 'galeria'])->name('filmes.galeria');
Route::get('/filmes/{filme}/detalhes', [FilmesController::class, 'detalhes'])->name('filmes.detalhes');
