...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            <a href="{{ route('index') }}"
                class="flex items-center text-white py-4 pl-6 nav-item @if(Request::is('/')) active-nav-link @else opacity-75 hover:opacity-100 @endif">
    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
            ...
            <main class="w-full flex-grow p-6">
                ...
                <div class="flex flex-wrap">
                    <div class="leading-loose min-w-full mb-2">
                        @if(session('erro'))
                            <div class="bg-red-200 border-t-4 border-red-500 rounded-b text-red-800 px-4 py-3 shadow-md"
                                role="alert">
                                <div class="flex">
        ...
        <footer class="w-full bg-white text-right p-4">
            Built by <a target="_blank" href="https://davidgrzyb.com" class="underline">David Grzyb</a>. <a
                href="https://www.flaticon.com/free-icons/person" title="person icons">Person icons created by Flat
                Icons - Flaticon</a>
        </footer>
    </div>
